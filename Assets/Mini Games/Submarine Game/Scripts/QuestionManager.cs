...
public class QuestionManager : MonoBehaviour
{
    ...
    // yeni soruyu ui'da degistirmek icin
    ...
    // cevabin dogru olup olmadigina bakiyo. dogruysa dogru soru sayisini degistiriyo
    public void CheckIsCorrectAnswer(int optionIndex)
    {
        ...
        if(optionIndex == correctIndex)
        {
            ...
            correctAnswerCount++;
            inciText.GetComponent<TextMeshProUGUI>().text = $"Inci sayisi: {correctAnswerCount}";
        }else
        {
